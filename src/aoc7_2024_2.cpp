...
private:
    ...
    long long SklejLiczby(long long a, long long b) const
    {
        // zamiana liczb na stringi, sklejenie ich i z powrotem na liczbe
    ...
    bool SprawdzRekurencyjnie(size_t index, long long biezacyWynik) const
    {
        ...
        // wywolanie sciezki sklejenia i sprawdzenie jej
        long long sklejona = SklejLiczby(biezacyWynik, nastepna);
        if (SprawdzRekurencyjnie(index + 1, sklejona))
        {
            return true;
        }
