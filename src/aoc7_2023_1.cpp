...
public:
    ...
    int ObliczTypUkladu()
    {
        ...
        //porzucenie wartosci karty, zliczanie w wektorze powtorzen zbioru kart ktore wystapily w zbiorze
        ...
        //po powyzszej petli uzyskano niekoniecznie posortowane powtorzenia kart
        //sortowanie wektora ilosci
